...
import { IoIosLink, IoMdAdd, IoMdClose, IoMdMic, IoMdSearch } from "react-icons/io";
    ...
    return (
      <div className="mt-5 flex w-full gap-2 p-2 md:gap-5 ">
        <div className="flex w-full items-center justify-start rounded-full border-none bg-gray-300 px-5 outline-none focus-within:shadow-sm">
          ...
          />
          {/* Close button */}
          <button className="ml-2 rounded-full bg-gray-300 p-2 text-gray-500" onClick={() => setSearchTerm("")}>
        ...
        <div className="flex items-center gap-5">
          ...
          {/* Creating new pin */}
          <Link to="/create-pin" className="flex items-center justify-center rounded-lg bg-blue-500 text-white md:h-12 md:w-14">
            <IoMdAdd />
          </Link>
        </div>
      </div>
