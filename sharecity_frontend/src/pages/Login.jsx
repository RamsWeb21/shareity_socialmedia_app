  ...
  return (
    <div className="flex h-screen flex-col items-center justify-start">
      <div className=" relative h-full w-full">
        <video src={shareVideo} type="video/mp4" loop controls={false} muted autoPlay className="h-full w-full object-cover" />
        ...
        <div className="absolute top-0 right-0 left-0 bottom-0 flex flex-col items-center justify-center bg-blackOverlay">
          ...
          <div className="m-5 p-3">
            ...
            <div className="flex flex-col items-center justify-center">
              <h1 className="text-3xl font-bold text-white">
                ...
                <TypeAnimation
                  sequence={["friends 😇", 2000, "family 👨‍👩‍👧‍👦", 2000, "colleagues 🤝", 2000, "world 🤗", 2000]}
                  wrapper="div"
                  cursor={true}
                  repeat={Infinity}
                  style={{
          ...
          <div className="flex gap-20 shadow-2xl">
            <button className="flex cursor-pointer items-center justify-center rounded-full bg-mainColor p-3 pr-5 outline-none hover:bg-opacity-80" onClick={signInWithGoogle}>
              <FcGoogle className="mr-4" />
              <span className=""> Google</span>
            </button>
            <button className="flex cursor-pointer items-center justify-center rounded-full bg-mainColor p-3 pr-5 outline-none hover:bg-opacity-80" onClick={signInWithGithub}>
